<?php
/**
 * Demo site setup for Sjöstad Service & Energi AB.
 *
 ...
 *
 * @package Sjöstad Service & Energi AB
 */
 ...
 * Site settings
 * ----------------------------------------------------------------------- */
update_option( 'blogname', 'Sjöstad Service & Energi AB' );
...
$home = nps_page(
	...
	nps_pattern( 'sjostadserviceochener/page-home' ),
...
nps_page(
	'takomlaggning',
	'Takomläggning',
	nps_pattern( 'sjostadserviceochener/page-replacement' ),
...
nps_page(
	...
	nps_pattern( 'sjostadserviceochener/page-storm' ),
...
$quote = nps_page(
	'offert',
	'Boka besiktning',
	nps_pattern( 'sjostadserviceochener/quote-funnel' ),
...
$thanks = nps_page(
	'tack',
	'Tack',
	nps_pattern( 'sjostadserviceochener/thank-you' ),
...
<p class="has-large-font-size">Sjöstad Service & Energi AB är ett familjeföretag från Sollentuna. Vi startade 1996 med en bil och en regel vi fortfarande håller oss till: priset vi skriver ner är priset du betalar.</p>
<!-- /wp:paragraph -->
...
<!-- /wp:list -->
HTML;
nps_page( 'om-oss', 'Om Sjöstad Service & Energi AB', $about_content . "\n\n" . nps_pattern( 'sjostadserviceochener/cta-inline' ), 'Familjeägt takföretag i norra Stockholm sedan 1996. Egna montörer, fasta priser skriftligt och 10 års garanti.' );
...
nps_page( 'vanliga-fragor', 'Vanliga frågor', $faq_content . "\n\n" . nps_pattern( 'sjostadserviceochener/cta-inline' ), 'Svar om offert, pris, ROT-avdrag, hur lång tid en takomläggning tar och vad garantin täcker.' );
...
<!-- /wp:paragraph -->
HTML;
$privacy = nps_page( 'integritetspolicy', 'Integritetspolicy', $privacy_content, 'Så använder Sjöstad Service & Energi AB uppgifterna du skickar med offertformuläret.' );
...
nps_log( 'Sjöstad Service & Energi AB demo ready.' );
