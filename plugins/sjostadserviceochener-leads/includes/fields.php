...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'sjostadserviceochener-leads' ),
				'storm'       => __( 'Storm or hail damage', 'sjostadserviceochener-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'sjostadserviceochener-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'sjostadserviceochener-leads' ),
				'not-sure'    => __( 'Vet inte än', 'sjostadserviceochener-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'sjostadserviceochener-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'sjostadserviceochener-leads' ),
				'research' => __( 'Jag kollar bara priser', 'sjostadserviceochener-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'sjostadserviceochener-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'sjostadserviceochener-leads' ),
		'contacted' => __( 'Kontaktad', 'sjostadserviceochener-leads' ),
		'quoted'    => __( 'Quote sent', 'sjostadserviceochener-leads' ),
		'won'       => __( 'Won', 'sjostadserviceochener-leads' ),
		'lost'      => __( 'Lost', 'sjostadserviceochener-leads' ),
		'spam'      => __( 'Misstänkt spam', 'sjostadserviceochener-leads' ),
	);
}
