 ...
 * Slug: sjostadserviceochener/how-it-works
...
?>
<!-- wp:group {"align":"full","className":"sj-sec-steps","style":{"spacing":{"padding":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70"}}},"layout":{"type":"constrained","contentSize":"1180px"}} -->
<div class="wp-block-group alignfull sj-sec-steps" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)"><!-- wp:heading {"align":"wide","fontSize":"xx-large"} -->
<h2 class="wp-block-heading alignwide has-xx-large-font-size">Så går det till</h2>
<!-- /wp:heading -->

<!-- wp:group {"align":"wide","className":"sj-steps","style":{"spacing":{"margin":{"top":"var:preset|spacing|50"},"blockGap":"var:preset|spacing|40"}},"layout":{"type":"grid","minimumColumnWidth":"14rem"}} -->
<div class="wp-block-group alignwide sj-steps" style="margin-top:var(--wp--preset--spacing--50)"><?php
$n = 0;
foreach ( $steps as $s ) :
	$n++;
	?><!-- wp:group {"className":"sj-step","layout":{"type":"default"}} -->
<div class="wp-block-group sj-step"><!-- wp:paragraph {"className":"sj-step-n"} -->
<p class="sj-step-n"><?php echo esc_html( (string) $n ); ?></p>
<!-- /wp:paragraph -->
