...
/**
 * Title: Not found
 * Slug: sjostadserviceochener/not-found
...
<div class="wp-block-button sj-track-cta"><a class="wp-block-button__link wp-element-button" href="<?php echo $url( '/free-quote/' ); ?>">Boka besiktning</a></div>
<!-- /wp:button -->
